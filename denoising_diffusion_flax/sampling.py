...
def ddpm_sample_step(state, rng, x, t, ddpm_params):
    # predicted_noise
...
def sample_loop(rng, state, shape, sample_step, timesteps):
    ...
    for t in reversed(jnp.arange(timesteps)):
        ...
        x, x0 = sample_step(state, step_rng, x, jax_utils.replicate(t))
        list_x0.append(x0)
    # normalize to [0,1]
